...
- ```sql
   ...
   - 외부 조인은 좌우로 나누어 지정할 수 있다. WHERE절에 조인 기준 열 중 한쪽에 `(+)`기호를 붙여준다.
     ...
     <img src="C:\Users\oh12s\Desktop\TIL\Coding Test\md-image\image-20210219103321303.png" alt="image-20210219103321303" style="zoom: 67%;" />
   
     
   
   2-5. NL조인
   
   ![img](https://t1.daumcdn.net/cfile/tistory/994377375B75B82205)
