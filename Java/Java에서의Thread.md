...
한 번 실행이 종료된 쓰레드는 다시 실행할 수 없다. 하나의 쓰레드에 대해 start()가 한 번만 호출될 수 있다는 뜻이다. 그래서 만일 쓰레드의 작업을 한 번 더 수행해야 한다면 아래와 같이 새로운 쓰레드를 생성한 다음에 start()를 호출해야 한다. <br>
...
<img width="455" alt="스크린샷 2021-04-09 오전 1 21 42" src="https://user-images.githubusercontent.com/46706670/115542523-530f9600-a2db-11eb-8c56-db994295fd18.png">
...
<img width="669" alt="스크린샷 2021-04-09 오전 1 27 12" src="https://user-images.githubusercontent.com/46706670/115542537-54d95980-a2db-11eb-8a3e-40f4a28ee61a.png">
...
<img width="635" alt="스크린샷 2021-04-09 오전 1 54 16" src="https://user-images.githubusercontent.com/46706670/115542668-79cdcc80-a2db-11eb-8a43-0cd89dc397ad.png">
...
<img width="537" alt="스크린샷 2021-04-09 오전 2 16 25" src="https://user-images.githubusercontent.com/46706670/115542721-86522500-a2db-11eb-8edc-de707b90f1eb.png">
...
Thread - 프로세스에서 동시에 실행되는 독립적인 실행 단위를 말함. 장점으로는 자원을 많이 사용하지 않고 구현이 쉬우며 범용성이 높다.
